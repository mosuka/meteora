...
const METHOD_RAFT_SERVICE_STATUS: ::grpcio::Method<super::common::Null, super::raft::StatusReply> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/meteora.raft.RaftService/Status",
...
impl RaftServiceClient {
    ...
    pub fn status_opt(&self, req: &super::common::Null, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::raft::StatusReply> {
        self.client.unary_call(&METHOD_RAFT_SERVICE_STATUS, req, opt)
    }

    pub fn status(&self, req: &super::common::Null) -> ::grpcio::Result<super::raft::StatusReply> {
        self.status_opt(req, ::grpcio::CallOption::default())
    }

    pub fn status_async_opt(&self, req: &super::common::Null, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::raft::StatusReply>> {
        self.client.unary_call_async(&METHOD_RAFT_SERVICE_STATUS, req, opt)
    }

    pub fn status_async(&self, req: &super::common::Null) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::raft::StatusReply>> {
